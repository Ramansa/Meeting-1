...
<form method="post" class="card shadow-sm">
  <div class="card-body row g-3">
    ...
    <div class="col-md-2">
      <label class="form-label">School Group ID</label>
      <input class="form-control" type="number" name="school_group_id" required>
    </div>
    <div class="col-md-2">
      <label class="form-label">Class Group ID</label>
    ...
    <div class="col-md-3">
      <label class="form-label">End (auto)</label>
      <input id="end_at" class="form-control" type="datetime-local" disabled>
    </div>
    <div class="col-md-3">
      <label class="form-label">Lesson ID (manual)</label>
      <input class="form-control" type="number" name="lesson_id" value="0">
    </div>
    <div class="col-12">
      <button class="btn btn-primary"><i class="fa-solid fa-calendar-plus"></i> Create</button>
